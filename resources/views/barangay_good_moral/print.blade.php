...
<head>
    ...
    <title>Good Moral - {{ $certificate->resident->full_name ?? '' }}</title>
    <style>
        @page {
            size: A4;
            margin: 12mm;
    ...
    <div class="page">
        ...
        <div class="content">
            <p>
                ...
                {{ ucfirst(strtolower($barangayDetails->barangay_name ?? $certificate->resident->barangay)) }},
                {{ ucfirst(strtolower($barangayDetails->city_municipality ?? $certificate->resident->city_municipality)) }},
                {{ ucfirst(strtolower($barangayDetails->province ?? $certificate->resident->province)) }}.
                To the best of my knowledge, the above-named person has not been involved in illegal activities within
                this barangay.
            </p>

            <p>
                This certification is issued upon the request of the above-named person for
                <strong>{{ $certificate->purpose }}</strong> and other legal purposes.
            </p>
        ...
        <div class="signature-row">
            <div class="applicant">
                <div style="margin-top:30px; padding-top:6px; text-decoration:underline">
                    {{ strtoupper($certificate->resident->full_name) }}<br>
                </div>
