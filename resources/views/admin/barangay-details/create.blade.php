...
@section('title', 'Add Barangay Details')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Barangay Details</h3>
                ...
                <form action="{{ route('barangay-details.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('region') is-invalid @enderror" 
                                           id="region" name="region" value="{{ old('region', 'VI') }}">
                                    @error('region')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('province') is-invalid @enderror" 
                                           id="province" name="province" value="{{ old('province', 'NEGROS OCCIDENTAL') }}">
                                    @error('province')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('city_municipality') is-invalid @enderror" 
                                           id="city_municipality" name="city_municipality" value="{{ old('city_municipality', 'HINOBA-AN') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('barangay_name') is-invalid @enderror" 
                                           id="barangay_name" name="barangay_name" value="{{ old('barangay_name', 'BACUYANGAN') }}" required>
                                    @error('barangay_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('captain_name') is-invalid @enderror" 
                                           id="captain_name" name="captain_name" value="{{ old('captain_name') }}">
                                    @error('captain_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('treasurer_name') is-invalid @enderror" 
                                           id="treasurer_name" name="treasurer_name" value="{{ old('treasurer_name') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="barangay_contact">Phone Number</label>
                                    <input type="text" class="form-control @error('barangay_contact') is-invalid @enderror" 
                                           id="barangay_contact" name="barangay_contact" value="{{ old('barangay_contact') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="barangay_email">Email Address</label>
                                    <input type="email" class="form-control @error('barangay_email') is-invalid @enderror" 
                                           id="barangay_email" name="barangay_email" value="{{ old('barangay_email') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('clearance_fee') is-invalid @enderror" 
                                           id="clearance_fee" name="clearance_fee" value="{{ old('clearance_fee', 50.00) }}">
                                    @error('clearance_fee')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('residency_fee') is-invalid @enderror" 
                                           id="residency_fee" name="residency_fee" value="{{ old('residency_fee', 30.00) }}">
                                    @error('residency_fee')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('indigency_fee') is-invalid @enderror" 
                                           id="indigency_fee" name="indigency_fee" value="{{ old('indigency_fee', 20.00) }}">
                                    @error('indigency_fee')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h5 class="text-primary">Logos & Signatures</h5>
                                <hr>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="logo1">Primary Logo</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="logo2">Secondary Logo</label>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Save Barangay Details
                        </button>
