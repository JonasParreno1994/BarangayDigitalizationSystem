        ...
        <div class="h-full bg-white dark:bg-[#0e1726] flex flex-col">
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                <a href="index.html" class="main-logo flex shrink-0 items-center">
                    <img class="ml-[10px] w-20 flex-none" src="{{ asset('/1.jfif') }}" alt="iBarangay Logo">
                    <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">iBarangay</span>
                </a>
                <button type="button" class="collapse-icon flex h-8 w-8 items-center justify-center rounded-full transition duration-300 hover:bg-gray-500/10 rtl:rotate-180 dark:text-white-light dark:hover:bg-dark-light/10" @click="$store.app.toggleSidebar()">
