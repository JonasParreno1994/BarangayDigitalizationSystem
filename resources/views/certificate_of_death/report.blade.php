...
<head>
    <meta charset="UTF-8">
    <title>Certificate of Death Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-title">Certificate of Death Report</div>
    ...
    <div class="certificate-section">
        <h3 class="section-title">Certificate of Death ({{ $reportData->count() }})</h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $cert->date_of_death ? $cert->date_of_death->format('m/d/Y') : 'N/A' }}</td>
                    <td>{{ Str::limit($cert->place_of_death, 20) }}</td>
                    <td>{{ Str::limit($cert->cause_of_death, 25) }}</td>
        ...
        <div class="no-data">
            ...
            <p>No Certificate of Death records found for the selected date range.</p>
        </div>
        @endif
    </div>
