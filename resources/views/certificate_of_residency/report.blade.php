...
<head>
    <meta charset="UTF-8">
    <title>Certificate of Residency Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="certificate-section">
        <h3 class="section-title">Certificate of Residency ({{ $reportData->count() }})</h3>
        ...
        <div class="no-data">
            ...
            <p>No Certificate of Residency records found for the selected date range.</p>
        </div>
        @endif
    </div>
