...
<head>
    ...
    <title>Certificate of Good Moral Character - {{ $certificate->resident->full_name }}</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
            ...
            <div style="width: 58%; display: flex; flex-direction: column; align-items: center; font-size: 15px; font-family: 'Times New Roman', Times, serif;">
                <div class="certificate-title" style="font-family: 'Bookman Old Style', serif;">CERTIFICATE OF GOOD MORAL CHARACTER</div>
