...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <h1 class="text-2xl font-bold">Certificate of First Time Jobseekers Details</h1>
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <h3 class="font-semibold">Resident's Information</h3>
            ...
            <div class="pt-4 flex justify-end">
                <a href="{{ route('cert_firstTime_Jobseeker.index') }}" class="btn btn-outline-secondary">Back to List</a>
            </div>
        </div>
    </div>
</div>
