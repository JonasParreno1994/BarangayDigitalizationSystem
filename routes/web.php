...
Route::middleware('auth')->group(function () {
    ...
    // Documents - Admin, Staff, Secretary, Treasurer
    Route::middleware(['role:Admin,Staff,Secretary,Treasurer'])->group(function () {
        Route::resource('documents', DocumentController::class);
        Route::get('documents/{document}/download', [DocumentController::class, 'download'])->name('documents.download');
    });

    // Residents & Household - Admin, Staff, Secretary, Treasurer, Encoder
    Route::middleware(['role:Admin,Staff,Secretary,Treasurer,Encoder'])->group(function () {
    ...
    Route::middleware(['role:Admin,Staff,Secretary,Treasurer'])->group(function () {
        ...
        Route::get('kp-cases/report-form', [KpCaseController::class, 'showReportForm'])->name('kp-cases.report-form');
        Route::get('kp-cases/generate-report', [KpCaseController::class, 'generateReport'])->name('kp-cases.generate-report');
        Route::get('kp-cases/generate-compliance-report', [KpCaseController::class, 'generateComplianceReport'])->name('kp-cases.generate-compliance-report');
        Route::get('kp-cases/{id}/print', [KpCaseController::class, 'print'])->name('kp-cases.print');
        Route::resource('kp-cases', KpCaseController::class);
    });
});
