...
<head>
    <meta charset="UTF-8">
    <title>Certificate of Indigency Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-title">Certificate of Indigency Report</div>
    ...
    <div class="certificate-section">
        <h3 class="section-title">Certificate of Indigency ({{ $reportData->count() }})</h3>
        ...
        <div class="no-data">
            ...
            <p>No Certificate of Indigency records found for the selected date range.</p>
        </div>
        @endif
    </div>
